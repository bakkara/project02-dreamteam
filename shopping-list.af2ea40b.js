...
<div class="shopping-card">
  ...
  `,v.appendChild(r);let i=r.querySelector(".delete-button");i.addEventListener("click",()=>{(function(e){(0,a.Loading).init();let t=k().filter(t=>t!==e);localStorage.setItem("targetBooks",JSON.stringify(t)),(0,a.Loading).remove()})(e._id),r.remove(),0===k().length&&(h.style.display="block")})}const S=k();v.innerHTML="",(0,a.Loading).init(),0===S.length?(h.style.display="block",E(!1)):(h.style.display="none",S.forEach(async e=>{try{let t=await y(e);_(t)}catch(e){console.log(e.message)}}),E(!0)),(0,a.Loading).remove();const F=document.querySelectorAll(".book-card");F.forEach(async e=>{let t=e.querySelector(".shopping-image").id;try{let o=await y(t);o&&_(o,e)}catch(e){console.log(e.message)}});
//# sourceMappingURL=shopping-list.af2ea40b.js.map
