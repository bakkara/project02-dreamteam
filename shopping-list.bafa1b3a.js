...
<div class="shopping-card">
  ...
  <div class = "shopping-descr">
      ...
      <button class="delete-button"><svg width="16" height="16" class="shopping-svg">
                    <use href="${t(v)}#icon-trash-03-1-1"></use></button>
    </div>
  `,b.appendChild(r);let a=r.querySelector(".delete-button");a.addEventListener("click",()=>{(function(e){(0,i.Loading).init();let t=k().filter(t=>t!==e);localStorage.setItem("targetBooks",JSON.stringify(t)),(0,i.Loading).remove()})(e._id),r.remove(),0===k().length&&(h.style.display="block")})}const S=k();b.innerHTML="",(0,i.Loading).init(),0===S.length?(h.style.display="block",E(!1)):(h.style.display="none",S.forEach(async e=>{try{let t=await y(e);_(t)}catch(e){console.log(e.message)}}),E(!0)),(0,i.Loading).remove();const H=document.querySelectorAll(".book-card");H.forEach(async e=>{let t=e.querySelector(".shopping-image").id;try{let o=await y(t);o&&_(o,e)}catch(e){console.log(e.message)}});
//# sourceMappingURL=shopping-list.bafa1b3a.js.map
