...
<div class="shopping-card">
  ...
  `,v.appendChild(r);let i=r.querySelector(".delete-button");i.addEventListener("click",()=>{(function(e){(0,a.Loading).init();let t=k().filter(t=>t!==e);localStorage.setItem("targetBooks",JSON.stringify(t)),(0,a.Loading).remove()})(e._id),r.remove(),0===k().length&&(h.style.display="block")})}const _=k();v.innerHTML="",(0,a.Loading).init(),0===_.length?(h.style.display="block",E(!1)):(h.style.display="none",_.forEach(async e=>{try{let t=await y(e);S(t)}catch(e){console.log(e.message)}}),E(!0)),(0,a.Loading).remove();const H=document.querySelectorAll(".book-card");H.forEach(async e=>{let t=e.querySelector(".shopping-image").id;try{let o=await y(t);o&&S(o,e)}catch(e){console.log(e.message)}});
//# sourceMappingURL=shopping-list.43227055.js.map
