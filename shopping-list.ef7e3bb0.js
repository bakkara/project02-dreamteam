...
<div class="shopping-card">
  ...
  `,d.appendChild(o);let n=o.querySelector(".delete-button");n.addEventListener("click",()=>{(function(e){let t=f().filter(t=>t!==e);localStorage.setItem("targetBooks",JSON.stringify(t))})(e._id),o.remove(),0===f().length&&(u.style.display="block")})})(o)}catch(e){console.log(e.message)}}),g(!0));let m=document.querySelectorAll(".book-card");m.forEach(e=>{let t=e.querySelector(".book-image").id;p(t).then(e=>findStoreLink(e))})}();
//# sourceMappingURL=shopping-list.ef7e3bb0.js.map
