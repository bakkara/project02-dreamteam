...
<div class="shopping-card">
  ...
  `,p.appendChild(t);let n=t.querySelector(".delete-button");n.addEventListener("click",()=>{(function(e){let o=g().filter(o=>o!==e);localStorage.setItem("targetBooks",JSON.stringify(o))})(e._id),t.remove(),0===g().length&&(d.style.display="block")})}const h=g();p.innerHTML="",0===h.length?(d.style.display="block",m(!1)):(d.style.display="none",h.forEach(async e=>{try{let o=await u(e);f(o)}catch(e){console.log(e.message)}}),m(!0));const b=document.querySelectorAll(".book-card");b.forEach(async e=>{let o=e.querySelector(".shopping-image").id;try{let t=await u(o);t&&f(t,e)}catch(e){console.log(e.message)}});
//# sourceMappingURL=shopping-list.0537aea2.js.map
