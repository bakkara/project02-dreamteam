...
<div class="shopping-card">
  ...
  `,d.appendChild(o);let n=o.querySelector(".delete-button");n.addEventListener("click",()=>{(function(e){let t=f().filter(t=>t!==e);localStorage.setItem("targetBooks",JSON.stringify(t))})(e._id),o.remove(),0===f().length&&(p.style.display="block")})}let m=f();d.innerHTML="",0===m.length?(p.style.display="block",g(!1)):(p.style.display="none",m.forEach(async e=>{try{let t=await u(e);h(t)}catch(e){console.log(e.message)}}),g(!0));let b=document.querySelectorAll(".book-card");b.forEach(async e=>{let t=e.querySelector(".shopping-image").id;try{let o=await u(t);o&&h(o,e)}catch(e){console.log(e.message)}})}();
//# sourceMappingURL=shopping-list.dee0a3f6.js.map
